...
We appreciate any contributions to the ``iterbox``.
...
How to contribute
-----------------
The preferred way to contribute to ``iterbox`` is to fork the main repository on GitHub,
work on your feature and then submit a PR. The outline of this process should be as follows:

1. Fork the `project repository <https://github.com/iterbox/iterbox>`_ by clicking on the **Fork** button near the top of the page.
...
2. Clone this copy to your local disk
   ::
      ...
      git clone git@github.com:YourGitHubLogin/iterbox.git
      cd iterbox

3. Most likely you would need (want) to install ``iterbox`` package into you environment in editable mode
   ::
